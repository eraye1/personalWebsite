    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="/tech.php">See more about my interests in the tech world &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="/assets/pics/ucla.jpg" alt="ucla" height="140" width="140">
          <h2>Education</h2>
          <p>Alumnus of UCLA and always proud to be a Bruin. UCLA, Fight, Fight, Fight!</p>
          <p><a class="btn btn-default" href="/ucla.php">See more about my education at UCLA &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="/hobbies.php">See more about my hobbies &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
